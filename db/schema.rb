...
ActiveRecord::Schema[7.1].define(version: 20_231_129_181_930) do
  ...
  create_table 'user_registrations', force: :cascade do |t|
    ...
    t.index %w[user_id tournament_id], name: 'index_user_registrations_on_user_id_and_tournament_id', unique: true
